...
1. **Crear** — cualquiera puede lanzar un token en segundos gratis (solo pagas
   el gas de la red). Todo token tiene un supply fijo de 1.000.000.000 y la
   misma
...
| --- | --- | --- |
| Creación de token | gratis (solo gas) | — |
